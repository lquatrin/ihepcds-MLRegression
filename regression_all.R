...
predictedY <- predict(r_e1071_svr_all, dataset_training)
residual_error <- dataset_training$Global - predictedY  # /!\ this time  svrModel$residuals  is not the same as data$Y - predictedY
...
title(main="Global Active Power Prediction")
